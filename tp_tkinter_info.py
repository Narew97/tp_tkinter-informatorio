...
reloj_label.place(x=10, y=10)

titulo_label =tk.Label(ventana_principal,text="selecciona una categoria del menu", font=("Arial", 13, "bold"), bg="#7EEA89", fg="black")
titulo_label.place(relx=0.5, y=8, anchor="n")
...
def mostrar_carnes():
    ...
    tk.Label(ventana, text="CARNES", font=("Helvetica", 18, "bold"), bg="#fcd17e").pack(fill="x", pady=10)
...
tk.Button(ventana_principal, text="CARNES", width=20, height=2, command=mostrar_carnes).place(x=50, y=60)
...
def mostrar_postres():
    ...
    ventana.geometry("500x600")
    ventana.configure(bg="#d1ecf3")
    tk.Label(text="mostrar_postres", font=("Helvetica", 18, "bold"), bg="#d1ecf3").pack(fill="x", pady=10)
